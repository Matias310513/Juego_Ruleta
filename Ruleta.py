...
if diferencia > 60:
    ...
    print(f'Ganaste, te demoraste {minutos} minutos y {segundos} segundos y {intentos} intentos en ganar')

else:
    print(f'Ganaste, te demoraste {diferencia} segundos y {intentos} intentos en ganar')